...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ...
    className={cn(
      "flex cursor-default select-none items-center rounded-xs text-sm font-medium outline-hidden focus:bg-transparent focus:text-slate-900 data-[state=open]:bg-transparent data-[state=open]:text-slate-900 dark:focus:text-slate-50 dark:data-[state=open]:text-slate-50",
      className
    )}
    {...props}
  />
...
>(({ className, inset, ...props }, ref) => (
  <MenubarPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center rounded-xs p-2 text-base outline-hidden focus:bg-slate-100 focus:text-slate-900 data-disabled:pointer-events-none data-disabled:opacity-50 dark:focus:text-slate-50",
      inset && "pl-8",
      className
    )}
    {...props}
